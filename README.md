...
* Python Version is 3.7 on local desktop and 3.11 on the institutional server.
  ...
  * Relevant packages include `numpy (1.21.6)`, `scipy (1.7.3)`, `seaborn (0.12.1)`, `matplotlib (3.5.3)`, `os`, `tqdm (4.64.1)`, `jax (0.3.25)`, `numpyro (0.10.1)`, `scikit-learn (1.0.2)`, `pyriemann (0.5)`, `mne (1.3.1)`, and `json (4.17.3)`.
